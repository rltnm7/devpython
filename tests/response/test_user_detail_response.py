...
import datetime
from response import UserDetailResponse
...
class TestUser:
    ...
    def test_eq_true(self):
        left = UserDetailResponse(id=1, username='nana-mizuki', name='Nana Mizuki',
            birthday=datetime.date(1980, 1, 21), age=42)
        right = UserDetailResponse(id=1, username='nana-mizuki', name='Nana Mizuki',
            birthday=datetime.date(1980, 1, 21), age=42)
        assert left == right
    ...
    def test_eq_false(self,
        ...
        left = UserDetailResponse(id=left_id, username=left_username, name=left_name,
            birthday=left_birthday, age=left_age)
        right = UserDetailResponse(id=right_id, username=right_username, name=right_name,
